...
from timm.models.ofa.utils import get_same_padding, min_divisible_value, SEModule, ShuffleLayer
from timm.models.ofa.utils import MyNetwork, MyModule
from timm.models.ofa.utils import build_activation, make_divisible
...
class ResidualBlock(MyModule):
	...
	def __init__(self, conv, shortcut, drop_path_rate=0):
