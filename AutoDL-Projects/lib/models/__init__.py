...
def get_cell_based_tiny_net(config):
  ...
  elif super_type == 'mobilenet':
    from .cell_searchs import mobilenet_super_nets as nas_super_nets
    return nas_super_nets[config.name](n_class=config.num_classes, stages=config.stages, zero_gamma=config.zero_gamma, affine=config.affine)
